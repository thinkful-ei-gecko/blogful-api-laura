...
describe.only('Articles Endpoints', function() {
  ...
  describe('GET /articles/:article_id', () => {
    context(`Given no articles`, () => {
      it(`responds with 404`, () => {
        ...
        return supertest(app).get(`/articles/${articleId}`)
    ...
    context('Given articles in database', () => {
      ...
      it('responds with 200 and the specified article', () => {
        ...
        return supertest(app).get(`/articles/${articleId}`).expect(200)
          .then(res => {
  ...
  describe(`POST /articles`, () => {
    it(`creates an article, responds with 201 and the new article`,  function() {
      ...
      return supertest(app).post('/articles')
    ...
    it('removes XSS attack content from response', () => {
      const { maliciousArticle, expectedArticle } = makeMaliciousArticle()
      return supertest(app).post(`/articles`).send(maliciousArticle)
        .expect(201)
        .expect(res => {
  ...
  describe.only(`DELETE /articles/:article_id`, () => {
    context('Given there are articles in the database', () => {
      ...
      it('responds with 204 and removes the article', () => {
        ...
        return supertest(app).delete(`/articles/${idToRemove}`).expect(204)
          .then(res => {
            console.log(res);
            return supertest(app)
            .get(`/articles`)
